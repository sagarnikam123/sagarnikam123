...
### 🛠️ Tech Stack
- **Cloud & DevOps**: AWS, Loki, Grafana, Fluent-bit, Docker, Kubernetes, Terraform, Ansible, Jenkins
- **Languages**: Go, Python, Shell, R, Java, C
- **Specialties**: Centralized Logging, Infrastructure as Code, CI/CD Automation

### 🔥 Featured Projects
- **[fuzzy-train](https://github.com/sagarnikam123/fuzzy-train)** - Versatile fake log generator for testing Loki, Elastic Stack & Grafana
- **[sagarnikam123-blog-youtube-code-samples](https://github.com/sagarnikam123/sagarnikam123-blog-youtube-code-samples)** - Code samples from my technical blog & YouTube tutorials
- **[ekTara](https://github.com/sagarnikam123/ekTara)** - Marathi OS interface prototype exploring localization

### 📝 Content Creator
- 📖 **Blog**: [sagarnikam123.github.io](https://sagarnikam123.github.io) - DevOps tutorials & best practices
- 🎥 **YouTube**: [sagarnikam123](https://youtube.com/sagarnikam123) - Technical tutorials & guides
